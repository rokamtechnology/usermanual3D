    ...
    def convert_to_pdf(self):
        ...
        <head>
            ...
            <style>
                ...
                h2 {{ color: #444; font-size: 1.5em; margin-top: 1.5em; margin-bottom: 0.5em; page-break-before: always; }}
        ...
        # Convert HTML to PDF using wkhtmltopdf with the necessary flags
        try:
            command = [
                'wkhtmltopdf',
                '--enable-local-file-access',   # Enable local file access
                '--allow', os.path.dirname(self.html_file), 
                self.html_file, 
                self.pdf_file
            ]
...
if __name__ == "__main__":
    markdown_file_path = r'C:\Users\ROKAM\THANUSH\usermanual3D\docs\index.md'
    html_file_path = r'C:\Users\ROKAM\THANUSH\usermanual3D\site\index.html'
    pdf_file_path = r'C:\Users\ROKAM\THANUSH\usermanual3D\site\index.pdf'        # Final PDF file
